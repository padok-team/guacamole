...
- `TF_DAT_001` - [Data source should not depend on a value computed during apply](https://developer.hashicorp.com/terraform/language/data-sources#data-source-behavior)
